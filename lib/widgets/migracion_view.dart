...
Future<Map<String, String>> _cfHeaders() async {
...
const _rows = [
  ...
  _R(
    ...
    'EME',
    'En Evaluación',
    'Provisión de botón de pánico inalámbrico',
    12,
    750000,
  ),
  _R(
  ...
  _R(
    ...
    'EME',
    'En Evaluación',
    'Oferta Técnica evaluada con 0 puntos, se procede con reclamo',
    11,
    800000,
  ),
  _R(
  ...
  _R(
    ...
    'OTRO',
    'Desestimada',
    'No tenemos plataforma de encuestas con tantas funcionalidades',
    34,
    1529412,
  ),
  _R(
  ...
  _R(
    ...
    'GDOC',
    'Desestimada',
    'No tenemos gestor documental desarrollado',
    36,
    1500000,
  ),
  _R(
  ...
  _R(
    ...
    'SUAC',
    'Desestimada',
    'Se solicitan exigencias específicas para elaborar una propuesta competitiva en paralelo con Huechuraba, San Bernardo y Paine',
    12,
    1416667,
  ),
  _R(
  ...
  _R(
    ...
    'EME',
    'Desestimada',
    'Pide integración con bomberos (10% de la evaluación) - Usuarios 5.000 - Registros de 300.000',
    9,
    973909,
  ),
  _R(
  ...
  _R(
    ...
    'APP, TV',
    'Revocada',
    'Bases incorrectas: no suma 100% la evaluación',
    12,
    3342554,
  ),
  _R(
    ...
    'APP, TV',
    'Revocada',
    'No se puede postular por las HH de las BA',
    12,
    3342554,
  ),
  _R(
  ...
  _R(
    ...
    'APP, TV',
    'Revocada',
    'Municipalidad indica que proyecto estará incluido en otra plataforma',
    24,
    8000000,
  ),
  _R(
  ...
  _R(
    ...
    'EME',
    'Desestimada',
    'Integraciones con central telefónica, ISO 27001, ISO 22301, ISO9001, ISO 37001',
    24,
    11521875,
  ),
  _R(
    ...
    'EME',
    'Desestimada',
    'Certificaciones ISO 27001, ISO 22301, ISO9001, ISO 37001',
    12,
    3000000,
  ),
  _R(
    ...
    'AGENDA',
    'Desestimada',
    'No tenemos servicio de contactabilidad vía whatsapp con chatbot',
    12,
    691586,
  ),
  _R(
  ...
  _R(
    ...
    'EME',
    'Desestimada',
    'Requiere integración con Bomberos y base de usuarios preexistente de 300.000 registros',
    12,
    2688929,
  ),
  _R(
    ...
    'TYA',
    'Desestimada',
    'App móvil + sistema campeonatos + geolocalización requeridos en 20 días hábiles; presupuesto máximo \$22.000.000 en 24 meses',
    24,
    916667,
  ),
  _R(
    ...
    'APP, TYA, TV, WEB',
    'Revocada',
    'Se revoca por no adjuntar documentos',
    36,
    4186701,
  ),
  _R(
  ...
  _R(
    ...
    'WEB',
    'Desestimada',
    'Criterios de evaluación ambiguos en licitación anterior',
    12,
    2666667,
  ),
  _R(
  ...
  _R(
    ...
    'SUAC',
    'Desestimada',
    'Certificaciones y Estándares: A lo menos ISO 27001 y/o SOC 2 u otras no mencionadas, adicionalmente cumplir con GDPR',
    18,
    25862813,
  ),
  _R(
  ...
  _R(
    ...
    'SUAC',
    'Desierta',
    'Requisito de certificaciones en laravel',
    14,
    4752548,
  ),
  _R(
    ...
    'GDOC',
    'Competencia',
    'Bajo presupuesto, solo soporte y mantención',
    6,
    1100000,
  ),
  _R(
  ...
  _R(
    ...
    'LIC',
    'Revocada',
    'Presupuesto escaso; revocada por problemas con los TTR',
    12,
    541667,
  ),
  _R(
  ...
  _R(
    ...
    'WEB',
    'Desestimada',
    'Requiere cake para el framework',
    9,
    3363527,
  ),
  _R(
  ...
  _R(
    ...
    'EME',
    'Desestimada',
    'Requiere funcionalidades adicionales',
    12,
    2700000,
  ),
  _R(
    ...
    'ATV',
    'Desierta',
    'Entidad señala que al cambiar el año presupuestario no fue agregado al respectivo presupuesto',
    1,
    17850499,
  ),
  _R(
  ...
  _R(
    ...
    'CHBOT, SUAC',
    'Competencia',
    'Precios presentados por otros oferentes muy por debajo del precio presentado por Meetcard',
    24,
    2833333,
  ),
  _R(
    ...
    'TYA',
    'Desestimada',
    'Presupuesto bajo \$7.000.000 y requiere módulo de torneos e integración con torniquetes y pasarela de pago',
    12,
    583333,
  ),
  _R(
    ...
    'GDOC',
    'Desestimada',
    'Requiere demo de presentación posterior al envío de la propuesta',
    36,
    4497306,
  ),
  _R(
    ...
    'CHBOT',
    'Desestimada',
    'Reclamo por ilegalidad de criterio de evaluación; 13/08/2024 se acoge íntegramente el reclamo',
    24,
    4908750,
  ),
  _R(
  ...
  _R(
    ...
    'GDOC',
    'Competencia',
    'Se descarta postulación por plazos de elaboración de propuesta',
    36,
    1300000,
  ),
  _R(
    ...
    'EME',
    'Competencia',
    'Se descarta por dispositivos externos (botones de pánico)',
    12,
    8333333,
  ),
  _R(
    ...
    'AGENDA',
    'Desestimada',
    'Exige al menos 1 experiencia comprobable',
    36,
    4000000,
  ),
  _R(
    ...
    'APP, TV, TYA, WEB, OTRO',
    'Desierta',
    'Presupuesto insuficiente y requerimiento de módulo financiero-contable',
    24,
    1257617,
  ),
  _R(
    ...
    'GDOC',
    'Competencia',
    'Requiere implementación en al menos 1 comuna',
    12,
    2590000,
  ),
  _R(
    ...
    'CORREOS, WEB',
    'Revocada',
    'Solicita visitas técnicas presenciales 1 vez por semana',
    20,
    1700000,
  ),
  _R(
  ...
  _R(
    ...
    'ATV',
    'Desestimada',
    'No responden preguntas realizadas; pedían software específico',
    12,
    3863750,
  ),
  _R(
  ...
  _R(
    ...
    'TYA',
    'Desestimada',
    'Solicitan demo para el jueves 22/5',
    36,
    2270917,
  ),
  _R(
  ...
  _R(
    ...
    'EME',
    'Desestimada',
    'Requiere más de 1,5 millones de usuarios registrados',
    24,
    1780958,
  ),
  _R(
  ...
  _R(
    ...
    'WEB',
    'Revocada',
    'Se adjudica a Cybercenter pero la revocan luego del reclamo de JBA',
    24,
    1423000,
  ),
  _R(
    ...
    'WEB',
    'Desestimada',
    'Requiere Wordpress (BA página 2)',
    12,
    null,
  ),
  _R(
  ...
  _R(
    ...
    'ATV, GDOC',
    'Competencia',
    'No responden preguntas del foro',
    12,
    null,
  ),
  _R(
  ...
  _R(
    ...
    'WEB',
    'Revocada',
    'Requiere solo mantención; la municipalidad es propietaria del sitio web',
    24,
    1423000,
  ),
  _R(
    ...
    'EME',
    'Desierta',
    'Requería 300.000 usuarios registrados en la plataforma',
    12,
    3090589,
  ),
  _R(
  ...
  _R(
    ...
    'ATV',
    'Desestimada',
    'Falta presupuesto para adicionales como pago de plan de datos',
    10,
    3200000,
  ),
  _R(
  ...
  _R(
    ...
    'EME',
    'Desierta',
    'Funcionalidades incompatibles con Meetcard (punto 17 BT)',
    10,
    2618000,
  ),
  _R(
    ...
    'WEB',
    'Desestimada',
    'Solicitan Intranet, Tarjeta Vecino, Portal Ciudadano y entrega CF',
    36,
    1934537,
  ),
  _R(
  ...
  _R(
    ...
    'ATV',
    'Revocada',
    'Se revoca por cambio de administración',
    12,
    1666667,
  ),
  _R(
  ...
  _R(
    ...
    'APP, TV',
    'Revocada',
    'No respondieron preguntas realizadas',
    12,
    3984172,
  ),
  ...
  _R(
    ...
    'PROY',
    'Desestimada',
    'Complejidad de hacer un mix de proyectos y atv',
    4,
    5209305,
  ),
  _R(
  ...
  _R(
    ...
    'WEB',
    'Desestimada',
    'DataCenter en territorio nacional',
    14,
    2757143,
  ),
  _R(
  ...
  _R(
    ...
    'WEB',
    'Desierta',
    'Exige certificación ISO 9001 empresa y Drupal',
    36,
    940707,
  ),
  _R(
  ...
  _R(
    ...
    'ATV',
    'Desestimada',
    'No cumple con función de videollamada',
    12,
    708333,
  ),
  _R(
    ...
    'APP',
    'Competencia',
    'iAnalytic mejor oferta económica y equipo',
    6,
    8333333,
  ),
  _R(
  ...
  _R(
    ...
    'PAT',
    'Desestimada',
    'Adquisición indefinida del producto',
    12,
    2500000,
  ),
  _R(
  ...
  _R(
    ...
    'SUAC',
    'Finalizada',
    'Presupuesto Referencial de 2355 UF',
    16,
    5437500,
  ),
  _R(
...
class _MigracionViewState extends State<MigracionView> {
  ...
  Future<void> _migrateOne(_MigResult res) async {
      ...
      if (r.isLP) {
        ...
        if (resp.statusCode == 200) {
          ...
          for (final c in campos) {
            final label = (c['label'] ?? c['nombre'] ?? '')
                .toString()
                .toLowerCase();
            final d = LicitacionApiService.parseDate(c['valor']?.toString());
            if (d == null) continue;
            if (label.contains('fin') && label.contains('evaluaci')) {
              finEvaluacion = d;
            }
          ...
          for (final key in ['fechaVencimiento', 'vencimiento']) {
            final d = LicitacionApiService.parseDate(
              externalData[key]?.toString(),
            );
    ...
    if (fechaInicio != null) {
      body['fechaInicio'] = fechaInicio.toIso8601String();
    }
    if (fechaTermino != null) {
      body['fechaTermino'] = fechaTermino.toIso8601String();
    }

    final createResp = await http
        .post(
          Uri.parse('$_cfBase/crearProyecto'),
          headers: await _cfHeaders(),
    ...
    final fechaStr = fechaTermino != null
        ...
        : '';
    res.msg =
        'Creado · $institucion$fechaStr${proyectoId != null ? ' · $proyectoId' : ''}';
  }
    ...
    try {
      ...
      for (final r in [testLP, testCM]) {
        final match = r.isLP
            ...
            : all
                  .where((p) => p.urlConvenioMarco?.contains(r.cod) == true)
                  .firstOrNull;
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('$deleted proyecto(s) de prueba eliminado(s)'),
          ),
        );
      }
    } catch (e) {
    ...
    for (final row in items) {
      ...
      try {
        ...
        setState(
          () => _bqFixLog.add({
            'tipo': 'oc',
            'id': row['id_licitacion'],
            'oc': ocBQ,
            'msg': ok
                ? 'OC registrada → $proyectoId'
  ...
  Future<void> _crearProyectosFaltantes(
    ...
    for (final row in items) {
      ...
      try {
        ...
        if (info.ocdsData != null) {
          final releases =
              (info.ocdsData!['releases'] as List?)
                  ?.cast<Map<String, dynamic>>() ??
              [];
          if (releases.isNotEmpty) {
            final last = releases.last;
            final contracts =
                (last['contracts'] as List?)?.cast<Map<String, dynamic>>() ??
                [];
            if (contracts.isNotEmpty) {
              ...
              fechaTermino = LicitacionApiService.parseDate(
        ...
        fechaInicio ??= LicitacionApiService.parseDate(
          row['fecha_envio_oc']?.toString(),
        );

        // 3. Crear proyecto
        final body = <String, dynamic>{
          'institucion': info.institucion.isNotEmpty
              ? info.institucion
              : idLicit,
          'productos': '',
        ...
        String? proyectoId;
        try {
          proyectoId = json.decode(createResp.body)['id']?.toString();
        } catch (_) {}
    ...
    try {
      ...
      final duplicados =
          grupos.entries
              ...
              .toList()
            ..sort(
              (a, b) => (a['idLicitacion'] as String).compareTo(
                b['idLicitacion'] as String,
              ),
            );
  ...
  Future<void> _unificarTodos() async {
    ...
    for (final grupo in grupos) {
      ...
      final proyectos = List<Map<String, dynamic>>.from(
        grupo['proyectos'] as List,
      );
      ...
      for (final p in proyectos) {
        for (final oc
            in (p['idsOrdenesCompra'] as List?)?.cast<String>() ?? []) {
          allOCs.add(oc.trim());
        }
      }
      ...
      try {
        ...
        if (updResp.statusCode != 200) {
          throw Exception('actualizarProyecto: ${updResp.statusCode}');
        }
        ...
        setState(
          () => _dupLog.add({
            'ok': true,
            'msg':
                '$idLicit  ·  conservado: ${kept['id']}  ·  OCs: ${allOCs.length}  ·  eliminados: ${dups.length}',
          }),
        );
      } catch (e) {
        setState(
          () => _dupLog.add({'ok': false, 'msg': '$idLicit  ·  Error: $e'}),
        );
      }
  ...
  Future<void> _runAudit() async {
    ...
    for (final r in _rows) {
      ...
      final Proyecto? p = r.isLP
          ...
          : all
                .where((x) => x.urlConvenioMarco?.contains(r.cod) == true)
                .firstOrNull;
      ...
      if (p == null) {
        ...
        if (r.est.isNotEmpty &&
          ...
          issues.add(
            'estado: esperado "${r.est}" / actual "${p.estadoManual ?? 'null'}"',
          );
        }
        if (r.vm != null && p.valorMensual == null) {
          issues.add('sin valorMensual');
        }
        ...
        if (issues.isEmpty) {
          ...
          res.msg =
              '${p.institucion}  ·  ${fmt(p.fechaInicio)} → ${fmt(p.fechaTermino)}';
        } else {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (grupos.isEmpty && _dupLog.isEmpty) const SizedBox(height: 8),
          if (grupos.isNotEmpty) ...[
            const SizedBox(height: 16),
            ...grupos.map((grupo) {
              final idLicit = grupo['idLicitacion'] as String;
              final proyectos = (grupo['proyectos'] as List)
                  .cast<Map<String, dynamic>>();
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...proyectos.map((p) {
                      final ocs =
                          (p['idsOrdenesCompra'] as List?)?.cast<String>() ??
                          [];
                      return Padding(
  ...
  Widget _buildBQResult(Map<String, dynamic> r) {
    ...
    final fueraDeApp =
        (r['fueraDeApp'] as List?)?.cast<Map<String, dynamic>>() ?? [];
    final ocFaltante =
        (r['ocFaltante'] as List?)?.cast<Map<String, dynamic>>() ?? [];
    ...
    Widget section(
      ...
      List<Widget> Function(Map<String, dynamic>) rowBuilder,
    ) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Análisis OC vs Proyectos (BigQuery)',
            style: GoogleFonts.inter(
              fontSize: 15,
              fontWeight: FontWeight.w600,
              color: AppColors.textPrimary,
          ...
          Text(
            'Tabla: sistema_compras.meses_publicado_ordendecompra',
            style: GoogleFonts.inter(fontSize: 11, color: Colors.grey.shade400),
          ),
          const SizedBox(height: 14),
          Row(
            children: [
              kpi('Total en BQ', totalBQ, AppColors.textPrimary),
              const SizedBox(width: 8),
              kpi('En la app', totalEnApp, AppColors.successDeep),
              const SizedBox(width: 8),
              kpi('Fuera de la app', totalFuera, AppColors.errorDark),
              const SizedBox(width: 8),
              kpi('OC no registrada', totalOCFalt, AppColors.warningDark),
            ],
          ),

          // Proyectos en app con OC no registrada
          section(
            'OC de BQ no registrada en el proyecto',
            AppColors.warningDark,
            ocFaltante,
            (row) => [
              Text(
                '${row['id_licitacion']}  ·  ${row['institucion'] ?? ''}',
                style: GoogleFonts.inter(
                  fontSize: 12,
                  fontWeight: FontWeight.w600,
                ),
              ...
              Text(
                'OC BQ: ${row['id_oc_bq']}  ·  En app: ${ocList(row) ?? 'ninguna'}',
                style: GoogleFonts.inter(
                  fontSize: 11,
              ...
              if (row['fecha_envio_oc'] != null)
                Text(
                  'Envío OC: ${row['fecha_envio_oc']}  ·  ${row['meses_totales']} meses desde publicación',
                  style: GoogleFonts.inter(
                    fontSize: 11,
                    color: Colors.grey.shade500,
                  ),
          ...
          section(
            ...
            (row) => [
              ...
              Text(
                'OC: ${row['id_oc_bq']}  ·  Publicación: ${row['fecha_publicacion'] ?? '-'}  ·  Envío OC: ${row['fecha_envio_oc'] ?? '-'}',
                style: GoogleFonts.inter(
                  fontSize: 11,
                  color: Colors.grey.shade600,
                ),
              ...
              Text(
                '${row['meses_totales']} meses entre publicación y OC',
                style: GoogleFonts.inter(
                  fontSize: 11,
                  color: Colors.grey.shade500,
                ),
            ...
            Wrap(
              ...
              children: [
                if (ocFaltante.isNotEmpty)
                  ElevatedButton.icon(
                    onPressed: _bqFixRunning
                        ? null
                        : () => _registrarOCsFaltantes(ocFaltante),
                    icon: const Icon(Icons.add_link, size: 18),
                    label: Text(
                      'Registrar OCs faltantes (${ocFaltante.length})',
                      style: GoogleFonts.inter(fontWeight: FontWeight.w500),
                    ),
                    style: ElevatedButton.styleFrom(
                ...
                if (fueraDeApp.isNotEmpty)
                  ElevatedButton.icon(
                    onPressed: _bqFixRunning
                        ? null
                        : () => _crearProyectosFaltantes(fueraDeApp),
                    icon: const Icon(Icons.add_circle_outline, size: 18),
                    label: Text(
                      'Crear proyectos faltantes (${fueraDeApp.length})',
                      style: GoogleFonts.inter(fontWeight: FontWeight.w500),
                    ),
                    style: ElevatedButton.styleFrom(
          ...
          if (enApp.isNotEmpty) ...[
            const SizedBox(height: 16),
            Text(
              'En la app ($totalEnApp proyectos)',
              style: GoogleFonts.inter(
                fontSize: 13,
                fontWeight: FontWeight.w600,
            ...
            ...enApp.map(
              (row) => Container(
                ...
                child: Row(
                  children: [
                    Icon(
                      row['oc_bq_registrada'] == true
                          ? Icons.check_circle
                          : Icons.warning_amber,
                      size: 14,
                      color: row['oc_bq_registrada'] == true
                          ? AppColors.successDeep
                          : AppColors.warningDark,
                    ),
                    const SizedBox(width: 8),
        ...
        child: ConstrainedBox(
          ...
          child: ListView(
            ...
            children: [
              ...
              if (_log.isNotEmpty) ...[const SizedBox(height: 24), _buildLog()],
            ],
          ),
        ),
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _stat('Total filas', '${_rows.length}', AppColors.textPrimary),
              ...
              const SizedBox(width: 12),
              _stat('Convenios Marco', '$_cmCount', AppColors.primary),
            ],
          ),
          const SizedBox(height: 12),
          Container(
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              OutlinedButton.icon(
                onPressed: (_running || _dupLoading)
                    ? null
                    : _detectarDuplicados,
                icon: _dupLoading
                    ? const SizedBox(
  ...
  Widget _buildLog() {
    ...
    final hasAuditSummary =
        ok + warn + err > 0 && skip == 0 ||
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                if (hasAuditSummary) ...[
                  _chip('$ok OK', AppColors.successDeep),
                  const SizedBox(width: 6),
                  if (warn > 0) ...[
                    _chip('$warn avisos', AppColors.warningDark),
                    const SizedBox(width: 6),
                  ],
                  if (err > 0) _chip('$err faltantes', AppColors.errorDark),
                ],
              ],
            ),
          ),
  ...
  Widget _buildLogRow(_MigResult res) {
    final (color, icon) = switch (res.status) {
      _Status.ok => (AppColors.successDeep, Icons.check_circle_outline),
      _Status.skip => (AppColors.warningDark, Icons.skip_next_outlined),
      _Status.warn => (AppColors.warningDark, Icons.warning_amber_outlined),
      _Status.error => (AppColors.errorDark, Icons.error_outline),
      _Status.running => (
        const Color(0xFF2563EB),
          ...
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${res.row.mod.contains('Convenio') ? 'CM' : 'LP'}  ·  ${res.row.meses}m',
                  style: GoogleFonts.inter(
                    fontSize: 11,
                    color: Colors.grey.shade500,
                  ),
