...
class ConfiguracionData {
  ...
  List<String> tiposDocumento; // <── Campo agregado

  ConfiguracionData({
    required this.estados,
    required this.modalidades,
    required this.productos,
    required this.tiposDocumento, // <── Requerido en constructor
  });
  ...
  factory ConfiguracionData.fromJson(Map<String, dynamic> d) =>
      ConfiguracionData(
        ...
        productos: (d['productos'] as List? ?? [])
            ...
            .toList(),
        tiposDocumento: List<String>.from(
          d['tiposDocumento'] ?? [],
        ), // <── Mapeo desde JSON
      );
  ...
  Map<String, dynamic> toJson() => {
    ...
    'tiposDocumento': tiposDocumento, // <── Inclusión en JSON
  };
}
