      ...
      child: Column(
        ...
        children: [
          ...
          TextButton(
            ...
            child: Text(_expanded ? 'Ver menos' : 'Ver más', style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.primary)),
          ),
          if (_expanded) ...[
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const SizedBox(width: 8),
                                Flexible(child: Text(doc.nombre ?? 'Ver ficha', style: GoogleFonts.inter(fontSize: 12, color: AppColors.primary, fontWeight: FontWeight.w600))),
                              ],
                            ),
                          ),
                        ),
